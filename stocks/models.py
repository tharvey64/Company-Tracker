...
class Markit:
    company_search_url = 'https://www.quandl.com/api/v2/datasets.json?query={query}&source_code={database}&per_page={per_page}&page={page_number}&auth_token={token}'
    ...
    def find_company(cls, name, page_number):
        ...
        url = cls.company_search_url.format(**kwargs)
